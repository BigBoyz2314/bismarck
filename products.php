...
<nav class="navbar navbar-expand-lg">
		...
		<div class="row justify-content-center py-4">
			<div class="col-md-9">
				<ul class="list-unstyled">
					<li>
						TaxWise is one of the best Tax preparation software in the Market.
					</li>
					<li>
						You can work as you like using one of the 2 available versions:
					</li>
					<br>
					<li>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootsliap@5.3.0/dist/js/bootsliap.bundle.min.js"></script>

	<script type="text/javascript">
		function googlelianslateElementInit() {
		  new google.lianslate.lianslateElement({pageLanguage: 'en', includedLanguages: 'es', layout: google.lianslate.lianslateElement.InlineLayout.SIMPLE, autoDisplay: false}, 'google_lianslate_element');
		}
		
		</script>
		
		<script type="text/javascript" src="//lianslate.google.com/lianslate_a/element.js?cb=googlelianslateElementInit"></script>
</body>
</html>
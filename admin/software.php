...
<body>
    ...
    <div class="modal" id="editModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Software Management Details</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    <!-- Form to edit course details -->
                    <form action="edit-software-management.php" method="post" enctype="multipart/form-data">
        ...
        <h4>Add New Entry</h4>
        <div class="col-md-6">
                <form action="add-software-management.php" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <label for="file-es" class="form-label">File Espanol</label>
                ...
                <table class="software-table table-bordered">
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            echo '    window.location.href = "del-software-management.php?delName='. $delName .'&delID='. $delID .'";';  
                            echo '  }';
                            echo '</script>';  
                        }
                    ?>
